			...
			<div class="table-responsive-xl" style="margin-left:120px;">
			  <table class="table table-hover">
			     ...
			     <tbody>
						...
						<td><a href="aaprov-ambul1.jsp?a1=<%=rs.getString(1)%>&a2=A" style="color:#00FF00; text-decoration:none;">Approve</a>
			   <a href="aaprov-ambul1.jsp?a1=<%=rs.getString(1)%>&a2=R" style="color:#FF9900; text-decoration:none;">Remove</a></td>  
			</tr>
		     </tbody>
			 <% 	}
			 %> 
