...
<nav class="navbar fixed-top navbar-expand-lg navbar-blue scrolls">
  ...
  <div class="dropdown">
  <button class="dropbtn" style="padding:10px;"><%=((String)session.getAttribute("logname")).toUpperCase()%></button>
  <div class="dropdown-content">
  <a href="user-profile">Profile</a>
  <a href="user-prv-boking.jsp">Previous Booking</a>
  <a href="user-crt-boking.jsp">Current Booking</a>
  <a href="user-signout.jsp">Sign out</a>  </div>
</div> 
    </form>
</nav>
</div>
