    ...
    <div class="content_resize">
	  ...
	  <h2 class="main-bar-content">Welcome <%=pp%> to Admin Home</h2>        
        <div class="article">
			...
			<td width="379"><span class="style10  style5"><strong><%=rs.getString(3)%></strong></span></td></tr>
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>Vehicle No:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(2)%></strong></span></td></tr>
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>Owner Name:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(4)%></strong></span></td></tr>
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>Driver Name:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(5)%></strong></span></td></tr>
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>Contact No:</strong></span></td>
			...
			<tr><td width="120"><span class="style7 style2 style7"><strong>Timimg:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(10)%></strong></span></td></tr>
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>Base Price:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(11)%></strong></span></td></tr>
			 
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>Per km Price:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(12)%></strong></span></td></tr>
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>Avability:</strong></span></td>
			...
			<td><span class="style10  style5"><strong><%=rs.getString(16)%></strong></span></td></tr>
			</table>			 
