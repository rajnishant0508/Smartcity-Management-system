 ...
 <div class="header">
  <div class="container" style="max-width:1000px;"><br /><br /><br />
   ...
   <p style="font-size: 26px; color:#FFFFFF; text-align: center;">Helping to heal our best asset…our children.</p>
			...
			try{
			int cnt=1;
			String qry1="select * from booking b, vehicle v  where b.uid='"+(String)session.getAttribute("id")+"' and b.type='Ambulance' and (b.status='Pending' or b.status='Approved' ) and b.vid=v.vid order by(b.bookfromdate) ";
			//out.print(qry1);
