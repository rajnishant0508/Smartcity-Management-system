...
<head>
	...
	<style type="text/css">
	body{
	background-image: url("./images/sonja-punz-N47B_zibNGo-unsplash.jpg");
	width:100%;
	height:100%;
...
<nav class="navbar fixed-top navbar-expand-lg navbar-blue scrolls">
  ...
  <a href="#">Profile</a>
  <a href="#">Setting</a>
  <a href="admin-pend-fb.jsp">Pending Feedback</a>
  <a href="admin-view-fb.jsp">Processed Feedback</a>
  <a href="admin-signout.jsp">Sign out</a>  </div>
</div> 
    </form>
</nav>
</div>
