  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <h2 class="main-bar-content">Welcome <%=pp%> to Member Home</h2>
	     <div class="article">
		   <form action="path-edit-blood2.jsp" onSubmit="return validate()">
		    <%
			 try{
		     ...
		     <table style="margin-left:120px; margin-top:30px;">
			   <tr> 
				...
				<td><select name="select" class="form-control" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					  ...
					  <option value="Brest MRI">Brest MRI</option>
					  <option value="Colonoscopy">Colonoscopy</option>
					  <option value="CT Scan">CT Scan</option>
					  <option value="Digital Rectal Exam(DRE)">Digital Rectal Exam(DRE)</option>
					  <option value="EKG">EKG</option>
					  <option value="Endoscopy">Endoscopy</option>
					  <option value="FOB Test">FOB Test</option>
					  <option value="MRI">MRI</option>
					  <option value="Mammography">Mammography</option>
					  <option value="MUGA Scan">MUGA Scan</option>
					  ...
					  <option value="Tumor Maker Test">Tumor Maker Test</option>
					  <option value="Ultrasound">Ultrasound</option>
					  <option value="Upper Endoscopys">Upper Endoscopys</option> 
                    </select></td>
				</tr>
				<tr>
				<td>Fee:</td>
