...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	  <h2 class="main-bar-content">Welcome <%=pp%> to Hotel Update Status Portal</h2>
        <div class="article">
		   ...
		   <div class="table-responsive-xl" >
			  <table class="table table-hover">
			     ...
			     <tbody>
						...
						<td><a href="hotel-chkout-update-status1.jsp?a1=<%=rs.getString(1)%>&a2=A" style="color:#00FF00; text-decoration:none;">Expired</a></td>
