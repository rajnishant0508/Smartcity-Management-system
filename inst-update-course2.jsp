  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <h2 class="main-bar-content">Welcome <%=pp%> to Update Course</h2>
	     <div class="article">
		   <%
		     String incrid=request.getParameter("incrid");
		     String course=request.getParameter("course");
			 String fee=request.getParameter("fee");
			 String dur=request.getParameter("dur");
			 String timing=request.getParameter("timing");
			 String startson=request.getParameter("starton");
			 String descr=request.getParameter("descr");
			 try{
			   st.executeUpdate("update instcrs set course='"+course+"', fee='"+fee+"', dur='"+dur+"', timing='"+timing+"', startson='"+startson+"',descr='"+descr+"' where incrid='"+incrid+"'");
