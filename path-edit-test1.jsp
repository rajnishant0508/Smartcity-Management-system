  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <h2 class="main-bar-content">Welcome <%=pp%> to Edit Test</h2>
	     <div class="article">
		   <form action="path-edit-test2.jsp">
		    <%
			 try{
		      String tid=request.getParameter("a1");
			...
			%>	
		     ...
		     <table style="margin-left:120px; margin-top:30px;">
			   <tr> 
				<td>Test Type:* </td>
				<td><select name="select" class="form-control" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" value="<%=rs.getString(3)%>">
