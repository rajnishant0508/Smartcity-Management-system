  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <h2 class="main-bar-content">Welcome <%=pp%> to </h2>
        ...
        <div class="article">
				<form method="post" action="inst-fb1.jsp">
				...
				<input type="hidden" name="phone" value="<%=rs.getString(6)%>">
				<tr>
				<td><span class="style3">Institute Name:</span></td>
					...
					<td><input type="text" name="email" class="form-control" value="<%=rs.getString(8)%>" placeholder="Email" readonly="true" />
