  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <h2 class="main-bar-content">Welcome <%=pp%> to </h2>
        ...
        <div class="article">
				<form method="post" action="blood-fb1.jsp">
				
				<%
					try{
						String s1=(String) session.getAttribute("id");
						ResultSet rs=st.executeQuery("select b. * from organisation b, login a where a.id='"+s1+"' and a.id=b.oid and a.type='BLOODBANK'");
						if(rs.next()){
				%>
				<table class="table-content">
				<input type="hidden" name="phone" value="<%=rs.getString(9)%>">
				<tr>
				<td><span class="style3">Blood Bank Name:</span></td>
					<td><input type="text" name="name" class="form-control" value="<%=rs.getString(2)%>" placeholder="Hospital Name" readonly="true" ></td>
					<td></td>
					<td><span class="style3">Email Address:</span></td>
					<td><input type="text" name="email" class="form-control" value="<%=rs.getString(10)%>" placeholder="Email" readonly="true" />
