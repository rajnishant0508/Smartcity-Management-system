...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	  <h2 class="main-bar-content" style="color:#DC7633; margin-bottom:50px;">Welcome <%=pp%> to PathLab Profile</h2>
			...
			qry="select a.* from organisation a,login b where a.oid=b.id and b.status='y' and a.type='PATH LAB' and  oid='"+id+"'";
			//out.print(qry+"<br>");
			...
			<tr><td>
				...
				<td width="379" bordercolor="#000000"><span class="style10 style5 "><%=rs.getString(2)%></span></td>
				</tr>
			...
			<h4 style="margin-bottom:50px; margin-top:50px;">View Department Details Here</h4>
						 ...
						 <tr>
						 <td width="354" bgcolor="#CCCCCC"><span class="style7 style7 style4"><strong>Test Type</strong></span></td>
						 <td width="144" bgcolor="#CCCCCC"><span class="style7 style7 style4"><strong>Fees</strong></span></td>
						 <td width="192" bgcolor="#CCCCCC"><span class="style7 style7 style4"><strong>Days</strong></span></td>
						 </tr>
						 <% 
						  qry="select a.*,b.* from lab a,organisation b where a.oid='"+id+"'  and b.oid='"+id+"' ";
						 //out.print(qry);
						 ...
						 %>
				<tr>
			<td height="29" bgcolor="#CCCCCC"><span class="style10"><%=rs.getString(3)%></span></span></td>
						<td bgcolor="#CCCCCC"><span class="style10 style5 style4"><%=rs.getString(4)%></span></td>
						<td bgcolor="#CCCCCC"><span class="style10 style5 style4"><%=rs.getString(5)%></span></td>
						</tr>
						<% }
						%>  	 
					   </table>
