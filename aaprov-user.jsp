    ...
    <div class="content_resize">
	  ...
	  <h2 class="main-bar-content">Welcome <%=pp%> to Admin Home</h2>        
        <div class="article">
			 <%
			try{
			 ResultSet rs=st.executeQuery("select a .* from user a,login b where a.uid=b.id and b.status='N'");
			%>	
			<div class="table-responsive-xl" style="margin-left:120px; margin-top:30px;">
			 <table class="table table-hover">
			     ...
			     <tbody>
						...
						<td><a href="aaprov-user1.jsp?a1=<%=rs.getString(1)%>&a2=A" style="color:#00FF00; text-decoration:none;">Approve</a>
