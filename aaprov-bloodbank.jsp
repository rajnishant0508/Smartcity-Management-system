...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	  <h2 class="main-bar-content">Welcome <%=pp%> to Blood Bank Details View </h2>
	   
          
		   <table class="tabl">
		   <tr>
				<td><a href="admin-blood-avalb.jsp" class="btn btn-primary">Blood Availability</a></td> 
				<td><a href="admin-bloodbank-pending.jsp" class="btn btn-primary">Pending Blood Donation</a></td> 
				<td><a href="admin-bloodbank-approv.jsp" class="btn btn-primary">Blood Donation History</a></td>
		  </tr> 
		  </table>
        </div>
  ...
  <div class="footer">
    <footer>
	<div class="Footer-wrapper" style="margin-top:600px;">
