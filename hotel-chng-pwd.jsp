  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <h2 class="main-bar-content">Welcome <%=pp%> to Change password:</h2>
	     <div class="article">
		   <form action="hotel-change-pwd1.jsp" onSubmit="return validate()">
		     <table style="margin-left:120px; margin-top:30px;">
			   <tr> 
				<td>Enter New Password: </td>
				<td><input type="password" name="pwd" class="form-control" id="pwd" placeholder="New Password" required></td>
				</tr>
