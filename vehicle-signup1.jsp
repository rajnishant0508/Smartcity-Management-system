...
<div class="main-content">
	  ...
	  <span style="color:maroon; font-size:25px;" class="style4">Vehicle Signup</span>
              ...
              <form name="f2" method="get" action="vehicle-signup2.jsp">
			  <table>
			  <b>Enter your Vehicle Registration Number</b>
			   <tr>
					<td><br /><b>Type:&nbsp;&nbsp;</b></td>
					<td><input type="text" value="<%=request.getParameter("select")%>" readonly="true" name="type" class="form-control"></td>
				</tr>
				<tr>
					<td><br /><b>Regd No:&nbsp;&nbsp;</b></td>
					<td><input type="text" name="regdno" placeholder="Registration No" class="form-control"></td>
				</tr>
						<tr><td></td></tr>
			  ...
			  <%
			    try{
				  ...
				  if(z.equalsIgnoreCase("error")){
				    out.print("<font color=red size=6>Allready Register...!!!</font>");
				  }
				}catch(Exception e){  }
			  %>
		</center>
