...
<div class="main-content1-heading">
 ...
 <p style="color: green;">Welcome <%=((String)session.getAttribute("logname")).toUpperCase()%> to PATHLAB Information</p>
 
		 	<div class="main-content1-heading">
				<p><u style="color: white;">PATHLAB</u></p>
			</div>
			<div class="main-content1-heading">
...
<form action="user-pathlab1.jsp">
  <div class="row">
    <div class="col-sm">
      <b style="font-size:20px; margin-left:150px;">Choose Pathlab:</b>
    </div>
	<%
		try{
		 ResultSet rs=st.executeQuery("select a .* from organisation a,login b where a.oid=b.id and b.status='y' and a.type='PATH LAB'");
