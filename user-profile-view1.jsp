    ...
    <div class="content_resize">
	  ...
	  <h2 class="main-bar-content">Welcome <%=pp%> to Admin Home</h2>        
        <div class="article">
			...
			<tr><td width="120"><span class="style7 style2 style7"><strong>DOB:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(3)%></strong></span></td></tr>
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>Gender:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(4)%></strong></span></td></tr>
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>Marignal Status:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(5)%></strong></span></td></tr>
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>Education:</strong></span></td>
			...
			<tr><td width="120"><span class="style7 style2 style7"><strong>Current Addrs:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(9)%></strong></span></td></tr>
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>Permanent Addrs:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(10)%></strong></span></td></tr>
			 
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>ID Type:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(11)%></strong></span></td></tr>
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>ID No:</strong></span></td>
			<td><span class="style10  style5"><strong><%=rs.getString(12)%></strong></span></td></tr>
			
			<tr><td width="120"><span class="style7 style2 style7"><strong>DOR:</strong></span></td>
