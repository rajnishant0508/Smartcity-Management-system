  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <h2 class="main-bar-content">Welcome <%=pp%> to </h2>
        ...
        <div class="article">
				<form method="post" action="vehicle-fb1.jsp">
				...
				<tr>
				<td><span class="style3">Vehicle Name:</span></td>
					...
					<td><input type="text" name="email" class="form-control" value="<%=rs.getString(7)%>" placeholder="Email" readonly="true" /></td>
