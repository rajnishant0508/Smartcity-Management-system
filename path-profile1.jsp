        ...
        <div class="article">
          <%
		      try{
				 ...
				 String tim=request.getParameter("timing");
				 String pt=request.getParameter("plotno");
				 st.executeUpdate("update organisation set pincode='"+pin+"', city='"+cit+"', area='"+are+"', dist='"+dis+"', state='"+stat+"', phone='"+ph+"', mail='"+ma+"', timing='"+tim+"', plotno='"+pt+"' where oid='"+s1+"'");
