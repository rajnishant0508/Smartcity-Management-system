    ...
    <div class="content_resize">
	  ...
	  <h2 class="main-bar-content">Welcome <%=pp%> to Admin Home</h2>        
        <div class="article">
		  ...
		  <form method="get" action="vehicle-view1.jsp">
			<%
			try{
			  ResultSet rs=st.executeQuery("select a .* from vehicle a,login b where a.vid=b.id and b.status='y'");
			 %>	
			 <table>
			<tr><td><span class="style6"><b style="font-size:20px; margin-left:120px;">Choose vehicle Name:&nbsp;&nbsp;&nbsp;</b></span></td>
			<td></td>
			...
			<%}catch(Exception ee){}%>
			 ...
			 <%
			try{
			 ResultSet rs=st.executeQuery("select a .* from vehicle a,login b where a.vid=b.id and b.status='y' order by(a.vid)  limit 15");
			%>	
